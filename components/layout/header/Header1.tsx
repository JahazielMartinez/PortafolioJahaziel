					...
					<div className="container py-3 px-0">
						...
						<div className="navbar-social d-flex align-items-center pe-5 pe-lg-0 me-5 me-lg-0">
							<div className="d-md-flex d-none gap-3">
								<Link href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/CV%2FJahazielDanielMarti%CC%81nezLorenzo%20Ingles.pdf?alt=media&token=3b69ba24-a508-4ea2-95e2-0d38c69412eb" target='_blank'>
									<i className="ri-file-text-fill fs-18" />
								</Link>
								<Link href="https://www.linkedin.com/in/jdmloficial/" target='_blank'>
