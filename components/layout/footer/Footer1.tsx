					...
					<div className="container position-relative z-1">
						<div className="text-center">
							<Link className="d-flex main-logo align-items-center d-inline-flex" href="/">
								<span className="fs-4 ms-2 text-white-keep">&lt;Jahaziel Martinez/&gt;</span>
							</Link>
							<div className="navigation d-none d-md-flex align-items-center justify-content-center flex-wrap gap-4 my-4">
								...
								<Link href="/certifications" className="fs-5">
									Certifications
								</Link>
						...
						<div className="row text-center py-4">
							<span className="fs-6 text-white-keep">© {new Date().getFullYear()} All Rights Reserved by <span><Link href="/#" className="text-primary-1">JahazielMartinez</Link></span>
							</span></div>
					</div>
