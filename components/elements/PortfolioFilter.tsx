		...
		<>
			...
			<div className="container">
				...
				<div className="row masonry-active justify-content-between mt-6">
					...
					<div className="filter-item col-lg-6 col-12 leadership app">
					...
					<div className="filter-item col-lg-6 col-12 marketing">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2024%2F04.png?alt=media&token=fb8bcf9d-2d4b-4f1a-9deb-48202e0ae058">
							...
							<div className="d-flex align-items-center mt-4">
								<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2024%2F04.png?alt=media&token=fb8bcf9d-2d4b-4f1a-9deb-48202e0ae058" className="project-card-content">
					...
					<div className="filter-item col-lg-6 col-12 marketing">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2024%2F03.png?alt=media&token=2d0683e3-2c9c-43b1-9a7d-fd536ae7f3b8">
							...
							<div className="d-flex align-items-center mt-4">
								<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2024%2F03.png?alt=media&token=2d0683e3-2c9c-43b1-9a7d-fd536ae7f3b8" className="project-card-content">
									<h3 className="fw-semibold">SEO from Scratch: Positioning...</h3>
									<p>Introductory Level</p>
								</Link>
							</div>
						</div>
					</div>
					<div className="filter-item col-lg-6 col-12 leadership">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2024%2F02.png?alt=media&token=ac03437a-f2df-4f8e-abd0-2fc97567264b">
							...
							<div className="d-flex align-items-center mt-4">
								<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2024%2F02.png?alt=media&token=ac03437a-f2df-4f8e-abd0-2fc97567264b" className="project-card-content">
									<h3 className="fw-semibold">How to Inspire and Motivate...</h3>
									<p>Intermediate Level</p>
								</Link>
							</div>
						</div>
					...
					<div className="filter-item col-lg-6 col-12 leadership">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2024%2F01.png?alt=media&token=dc14b8aa-260e-4501-a483-db47113a8062">
							...
							<div className="d-flex align-items-center mt-4">
								<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2024%2F01.png?alt=media&token=dc14b8aa-260e-4501-a483-db47113a8062" className="project-card-content">
					...
					<div className="filter-item col-lg-6 col-12 leadership">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2023%2F14.jpeg?alt=media&token=0601eac8-49ac-4ec5-98a5-a382f98fa079">
							...
							<div className="d-flex align-items-center mt-4">
								<Link target="_blank" href="https://firebasestorage.googleapis.com/v0/b/webdesignoficial-5dcdd.appspot.com/o/Certificaciones%2FCrehana%2F2023%2F14.jpeg?alt=media&token=0601eac8-49ac-4ec5-98a5-a382f98fa079" className="project-card-content">
